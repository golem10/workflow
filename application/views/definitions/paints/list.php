          ...
          <div class="box">
                <div class="box-header">              
				  <div class="btn-group pull-right">
						<a href="<?php echo base_url('definitions/addPaint');?>" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Dodaj</a>					
...
<div style="display:none">
 <?php echo form_open(base_url("definitions/editPaint"),array('id' => 'editFormSend','method' => 'post'),array());?>
	<input type="hidden" name="id_edit" id="id_edit" class="form-control" />
	<input type="hidden" name="redirect"  class="form-control" value='1' />
  <?php echo form_close();?>
  <?php echo form_open(base_url("definitions/deletePaint"),array('id' => 'deleteFormSend','method' => 'post'),array());?>
...
<script>
    $(function () {
        dTable = $("#dataTable").DataTable( {
			...
			"serverSide": true,
			"order": [[ 1, "asc" ]],
			"ajax": "<?php echo base_url("definitions/getAllTablePaints");?>",
			"language": {
