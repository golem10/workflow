                ...
                <div class="box-header">               
				  <div class="btn-group pull-right">
					    <?php if(isset($access[3][1])){?>
							<a href="<?php echo base_url('customers/add');?>" class="btn btn-success"><i class="fa fa-plus"></i>&nbsp;Dodaj</a>
						<?php }?>
						<?php if(isset($access[3][2])){?>
							<button type="button" id="buttonEdit" class="btn btn-default" disabled><i class="fa fa-pencil"></i>&nbsp;Edytuj</button>
						<?php }?>
						<?php if(isset($access[3][3])){?>
...
<div style="display:none">
 <?php echo form_open(base_url("customers/edit"),array('id' => 'editFormSend','method' => 'post'),array());?>
	<input type="hidden" name="id_edit" id="id_edit" class="form-control" />
	<input type="hidden" name="redirect"  class="form-control" value='1' />
  <?php echo form_close();?>
  <?php echo form_open(base_url("customers/delete"),array('id' => 'deleteFormSend','method' => 'post'),array());?>
